...
class RainTPL
{
     ...
     * @var array
     */
    public static $path_replace_list = array('img', 'link', 'script', 'input');
     ...
     * @param bool   $return_string true=return a string, false=echo the template
     *
     * @return string
     */

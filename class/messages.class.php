...
class messages extends phpCore
{
    ...
    public function bbcode($str,$truncate = null, $type = NULL,$pid = NULL,$id = NULL)
    {
        ...
        $str = preg_replace_callback('#\[twitter\](.+?)\[/twitter\]#im',function($m) {
          ...
          return '<img data-req="'.$req.'" data-content="'.urlencode($m[1]).'" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" onload="N.loadTweet(this)">'; //a blank 1x1 transparent gif image, only needed to call N.loadTweet
        },$str);

...
if($usernamechanged)
{
    ...
    if(db::NO_ERR != $core->query(array('INSERT INTO "posts" ("from","to","pid","message","notify", "time") VALUE ('.USERS_NEWS.','.USERS_NEWS.",{$lastpid}, :msg ,FALSE,NOW())",array($message)),db::FETCH_ERR))
        die($core->jsonResponse('error',$core->lang('ERROR')));
